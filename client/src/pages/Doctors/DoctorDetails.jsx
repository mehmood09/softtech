                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p className="text__para text-[14px] leading-6 md:text-[15px] lg:max-w-[390px]">
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum labore, reiciendis distinctio, aut iste voluptate temporibus modi praesentium facilis optio dicta tempora, possimus velit explicabo aspernatur asperiores id. Deleniti, quam.
                            </p>
                        </div>
                    </div>
