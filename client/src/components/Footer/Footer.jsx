        ...
        <footer className="pb-16 pt-10">
             <div className="hero__section container">
                <div className="flex justify-between flex-col md:flex-row flex-wrap gap-[30px]">
                    <div>
                    <h1 className="text-[20px] leading-[30px] font-[700] mb-6 text-textColor">MEHMOOD QADIR MS(CS)</h1>
                        <p className="text-[16px] leading-7 font-[700] text-textColor mt-4">
                           Phone No. +923130002348<br/>Email: alhamdsolution1@gmail.com<br/><br/><br/>
