        ...
        <section id="services">
            <div className='container lg:pt-5'>
                <div className='text-center'>
                    ...
                    We develop Front-End User Interfaces for various complex web applications using HTML, CSS, and JavaScript, optimizing websites for maximum speed and scalability.
                    </p>
                </div>
                <div className='flex flex-col justify-center sm:py-12'>
                    <div className='w-full py-3 px-2 sm:max-w-xl sm:mx-auto sm:px-0'>
                        <div className='relative text-gray-700 antialiased text-sm font-semibold'>
                            {/* ============= Vertical Line ruuning through the middle ============= */}
                                        ...
                                        <div className='w-full sm:w-1/2 sm:pr-8'>
                                            ...
                                            ease-in duration-150'>
                                                ...
                                                <p className='text-[15px] text-smallTextColor group-hover:text-white group-hover:font-[500] leading-7'>
                                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Commodi magni impedit quis
                                                </p>
                                            </div>
                                        </div>
                                    </div>
